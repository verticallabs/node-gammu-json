...
exports.prototype = {
    ...
    _transmit_messages: function (_callback) {
      ...
      self._subprocess(gammuJsonPath, args, function (_err, _rv) {
    ...
    _receive_messages: function (_callback) {
      ...
      self._subprocess(gammuJsonPath, [ 'retrieve' ], function (_err, _rv) {
